  ...
  return function (Component) {
    return {
      view: function view(controller, props, children) {
              ...
              if (typeof actions[k] === 'function') {
                actionMap[k] = function () {
                  ...
                  return function () {
                    ...
                    return dispatch(actions[k].apply(actions, factoryArgs.concat(args)));
                  };
                };
              }
            };
        ...
        return Provider.mithril.component(comp, _extends({ dispatch: dispatch }, state, actionMap), children);
      }
    };
  };
};
